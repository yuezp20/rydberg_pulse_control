...
import numpy as np
from rydberg_awg_test import find_waveform, find_Dwaveform
...
class Sequence(QMainWindow, Ui_sequence):
    def __init__(self, awg_control, config_name):
        ...
        self.waveform_420_file_name = None
        self.waveform_1013_file_name = None

        self.settings = qc.QSettings("../initialize/config.ini", qc.QSettings.IniFormat)
        self.load_config()

        my_parameter = "Custom Parameter"
        ...
        self.continue_phase.currentIndexChanged.connect(self.set_phi_visible)
        self.waveform_420_1.activated.connect(lambda index, param="420_1": self.onComboBoxActivated(index, param))
        self.waveform_420_2.activated.connect(lambda index, param="420_2": self.onComboBoxActivated(index, param))
        self.waveform_420_3.activated.connect(lambda index, param="420_3": self.onComboBoxActivated(index, param))
        self.waveform_420_4.activated.connect(lambda index, param="420_4": self.onComboBoxActivated(index, param))
        self.waveform_420_5.activated.connect(lambda index, param="420_5": self.onComboBoxActivated(index, param))
        self.waveform_420_6.activated.connect(lambda index, param="420_6": self.onComboBoxActivated(index, param))
        self.waveform_1013_1.activated.connect(lambda index, param="1013_1": self.onComboBoxActivated(index, param))
        self.waveform_1013_2.activated.connect(lambda index, param="1013_2": self.onComboBoxActivated(index, param))
        self.waveform_1013_3.activated.connect(lambda index, param="1013_3": self.onComboBoxActivated(index, param))
        self.waveform_1013_4.activated.connect(lambda index, param="1013_4": self.onComboBoxActivated(index, param))
        self.waveform_1013_5.activated.connect(lambda index, param="1013_5": self.onComboBoxActivated(index, param))
        self.waveform_1013_6.activated.connect(lambda index, param="1013_6": self.onComboBoxActivated(index, param))
    ...
    def onComboBoxActivated(self, index, param):
        if index == 3:
            file_dialog = QFileDialog()
            file_dialog.setDirectory("../waveform")
            options = QFileDialog.Options()
            file_name, _ = file_dialog.getOpenFileNames(
                self, "Open .csv File", "", "Text Files (*.csv)", options=options)

            if file_name:
                if "420" in param:
                    self.waveform_420_file_name[param] = file_name
                elif "1013" in param:
                    self.waveform_1013_file_name[param] = file_name

                self.informationBrowser.append(f"waveform has been loaded form file: {file_name}...")
            else:
                self.waveform_1013_file_name[param] = None
                self.findChildren(QComboBox, "waveform_{}".format(param))[0].setCurrentIndex(0)
                self.informationBrowser.append(f"load waveform has been failed...")
    ...
    def find_omega_fre_t(self):
        ...
        for single_wave in waveform_cont_420:
            if single_wave.form == "load from file":
                ...
                detuning_fun = single_wave.start_frequency
                time = single_wave.time
                # single_wave_omega_t = np.zeros(int(1000 * (time)))?????

                point_num = int(1000 * time)

                plot_t = np.linspace(0, time, point_num)
                omega_t = amp_fun(plot_t)
                frequency_t = detuning_fun(plot_t)

                omega_420_t = np.append(omega_420_t, omega_t)
                omega_420_t = np.asarray(omega_420_t)
                frequency_420_t = np.append(frequency_420_t, frequency_t)
                ...
                if single_wave.form == "flat pulse":
                    ...
                    for i in range(int(1000 * time)):
                        single_wave_frequency_t[i] = start_frequency + (
                                end_frequency - start_frequency) / time * i / 1000
        ...
        for single_wave in waveform_cont_1013:
            if single_wave.form == "load from file":
                ...
                omega_1013_t = np.append(omega_1013_t, omega_t)
                omega_1013_t = np.asarray(omega_1013_t)
                frequency_1013_t = np.append(frequency_1013_t, frequency_t)
    ...
    def set_phi_visible(self):
        if self.continue_phase.currentIndex() == 0:
            self.label_phi_420_1.setVisible(False)
            self.label_phi_420_2.setVisible(False)
            self.label_phi_420_3.setVisible(False)
            self.label_phi_420_4.setVisible(False)
            self.label_phi_420_5.setVisible(False)
            self.label_phi_420_6.setVisible(False)

            self.phi_420_1.setVisible(False)
            self.phi_420_2.setVisible(False)
            self.phi_420_3.setVisible(False)
            self.phi_420_4.setVisible(False)
            self.phi_420_5.setVisible(False)
            self.phi_420_6.setVisible(False)

            self.label_phi_1013_1.setVisible(False)
            self.label_phi_1013_2.setVisible(False)
            self.label_phi_1013_3.setVisible(False)
            self.label_phi_1013_4.setVisible(False)
            self.label_phi_1013_5.setVisible(False)
            self.label_phi_1013_6.setVisible(False)

            self.phi_1013_1.setVisible(False)
            self.phi_1013_2.setVisible(False)
            self.phi_1013_3.setVisible(False)
            self.phi_1013_4.setVisible(False)
            self.phi_1013_5.setVisible(False)
            self.phi_1013_6.setVisible(False)

        elif self.continue_phase.currentIndex() == 1:
            self.label_phi_420_1.setVisible(True)
            self.label_phi_420_2.setVisible(True)
            self.label_phi_420_3.setVisible(True)
            self.label_phi_420_4.setVisible(True)
            self.label_phi_420_5.setVisible(True)
            self.label_phi_420_6.setVisible(True)

            self.label_phi_1013_1.setVisible(True)
            self.label_phi_1013_2.setVisible(True)
            self.label_phi_1013_3.setVisible(True)
            self.label_phi_1013_4.setVisible(True)
            self.label_phi_1013_5.setVisible(True)
            self.label_phi_1013_6.setVisible(True)

            self.phi_420_1.setVisible(True)
            self.phi_420_2.setVisible(True)
            self.phi_420_3.setVisible(True)
            self.phi_420_4.setVisible(True)
            self.phi_420_5.setVisible(True)
            self.phi_420_6.setVisible(True)

            self.phi_1013_1.setVisible(True)
            self.phi_1013_2.setVisible(True)
            self.phi_1013_3.setVisible(True)
            self.phi_1013_4.setVisible(True)
            self.phi_1013_5.setVisible(True)
            self.phi_1013_6.setVisible(True)
    ...
    def load_config(self):
        ...
        continue_phase_value = int(self.settings.value("{}/CONTINUE_PHASE".format(self.config_name)))

        combox_420_double_pass_value = int(self.settings.value("{}/COMBOX_420_DOUBLE_PASS".format(self.config_name)))
        combox_1013_double_pass_value = int(self.settings.value("{}/COMBOX_1013_DOUBLE_PASS".format(self.config_name)))
        ...
        connected_420_1_value = int(self.settings.value("{}/Connected_420_1".format(self.config_name)))
        connected_420_2_value = int(self.settings.value("{}/Connected_420_2".format(self.config_name)))
        connected_420_3_value = int(self.settings.value("{}/Connected_420_3".format(self.config_name)))
        connected_420_4_value = int(self.settings.value("{}/Connected_420_4".format(self.config_name)))
        connected_420_5_value = int(self.settings.value("{}/Connected_420_5".format(self.config_name)))
        connected_420_6_value = int(self.settings.value("{}/Connected_420_6".format(self.config_name)))

        connected_1013_1_value = int(self.settings.value("{}/Connected_1013_1".format(self.config_name)))
        connected_1013_2_value = int(self.settings.value("{}/Connected_1013_2".format(self.config_name)))
        connected_1013_3_value = int(self.settings.value("{}/Connected_1013_3".format(self.config_name)))
        connected_1013_4_value = int(self.settings.value("{}/Connected_1013_4".format(self.config_name)))
        connected_1013_5_value = int(self.settings.value("{}/Connected_1013_5".format(self.config_name)))
        connected_1013_6_value = int(self.settings.value("{}/Connected_1013_6".format(self.config_name)))
        ...
        phi_420_1 = self.settings.value("{}/phi_420_1".format(self.config_name))
        ...
        phi_420_2 = self.settings.value("{}/phi_420_2".format(self.config_name))
        ...
        phi_420_3 = self.settings.value("{}/phi_420_3".format(self.config_name))
        ...
        phi_420_4 = self.settings.value("{}/phi_420_4".format(self.config_name))
        ...
        phi_420_5 = self.settings.value("{}/phi_420_5".format(self.config_name))
        ...
        phi_420_6 = self.settings.value("{}/phi_420_6".format(self.config_name))
        ...
        phi_1013_1 = self.settings.value("{}/phi_1013_1".format(self.config_name))
        ...
        phi_1013_2 = self.settings.value("{}/phi_1013_2".format(self.config_name))
        ...
        phi_1013_3 = self.settings.value("{}/phi_1013_3".format(self.config_name))
        ...
        phi_1013_4 = self.settings.value("{}/phi_1013_4".format(self.config_name))
        ...
        phi_1013_5 = self.settings.value("{}/phi_1013_5".format(self.config_name))
        ...
        phi_1013_6 = self.settings.value("{}/phi_1013_6".format(self.config_name))
        ...
        connected_420_times_1_value = self.settings.value("{}/connected_420_times_1".format(self.config_name))
        connected_420_times_2_value = self.settings.value("{}/connected_420_times_2".format(self.config_name))
        connected_420_times_3_value = self.settings.value("{}/connected_420_times_3".format(self.config_name))
        connected_420_times_4_value = self.settings.value("{}/connected_420_times_4".format(self.config_name))
        connected_420_times_5_value = self.settings.value("{}/connected_420_times_5".format(self.config_name))
        connected_420_times_6_value = self.settings.value("{}/connected_420_times_6".format(self.config_name))

        connected_1013_times_1_value = self.settings.value("{}/connected_1013_times_1".format(self.config_name))
        connected_1013_times_2_value = self.settings.value("{}/connected_1013_times_2".format(self.config_name))
        connected_1013_times_3_value = self.settings.value("{}/connected_1013_times_3".format(self.config_name))
        connected_1013_times_4_value = self.settings.value("{}/connected_1013_times_4".format(self.config_name))
        connected_1013_times_5_value = self.settings.value("{}/connected_1013_times_5".format(self.config_name))
        connected_1013_times_6_value = self.settings.value("{}/connected_1013_times_6".format(self.config_name))
        ...
        self.continue_phase.setCurrentIndex(continue_phase_value)

        self.combox_420_double_pass.setCurrentIndex(combox_420_double_pass_value)
        self.combox_1013_double_pass.setCurrentIndex(combox_1013_double_pass_value)
        ...
        self.Connected_420_1.setCurrentIndex(connected_420_1_value)
        self.Connected_420_2.setCurrentIndex(connected_420_2_value)
        self.Connected_420_3.setCurrentIndex(connected_420_3_value)
        self.Connected_420_4.setCurrentIndex(connected_420_4_value)
        self.Connected_420_5.setCurrentIndex(connected_420_5_value)
        self.Connected_420_6.setCurrentIndex(connected_420_6_value)

        self.Connected_1013_1.setCurrentIndex(connected_1013_1_value)
        self.Connected_1013_2.setCurrentIndex(connected_1013_2_value)
        self.Connected_1013_3.setCurrentIndex(connected_1013_3_value)
        self.Connected_1013_4.setCurrentIndex(connected_1013_4_value)
        self.Connected_1013_5.setCurrentIndex(connected_1013_5_value)
        self.Connected_1013_6.setCurrentIndex(connected_1013_6_value)
        ...
        self.phi_420_1.setText(phi_420_1)
        self.phi_420_2.setText(phi_420_2)
        self.phi_420_3.setText(phi_420_3)
        self.phi_420_4.setText(phi_420_4)
        self.phi_420_5.setText(phi_420_5)
        self.phi_420_6.setText(phi_420_6)

        self.phi_1013_1.setText(phi_1013_1)
        self.phi_1013_2.setText(phi_1013_2)
        self.phi_1013_3.setText(phi_1013_3)
        self.phi_1013_4.setText(phi_1013_4)
        self.phi_1013_5.setText(phi_1013_5)
        self.phi_1013_6.setText(phi_1013_6)
        ...
        self.Connected_420_times_1.setText(connected_420_times_1_value)
        self.Connected_420_times_2.setText(connected_420_times_2_value)
        self.Connected_420_times_3.setText(connected_420_times_3_value)
        self.Connected_420_times_4.setText(connected_420_times_4_value)
        self.Connected_420_times_5.setText(connected_420_times_5_value)
        self.Connected_420_times_6.setText(connected_420_times_6_value)

        self.Connected_1013_times_1.setText(connected_1013_times_1_value)
        self.Connected_1013_times_2.setText(connected_1013_times_2_value)
        self.Connected_1013_times_3.setText(connected_1013_times_3_value)
        self.Connected_1013_times_4.setText(connected_1013_times_4_value)
        self.Connected_1013_times_5.setText(connected_1013_times_5_value)
        self.Connected_1013_times_6.setText(connected_1013_times_6_value)

        # set visible for phase
        if continue_phase_value == 0:
            self.label_phi_420_1.setVisible(False)
            self.label_phi_420_2.setVisible(False)
            self.label_phi_420_3.setVisible(False)
            self.label_phi_420_4.setVisible(False)
        ...
        with open('../initialize/shared_data.pickle', 'rb') as file:
            loaded_combined_dict = pickle.load(file)

        self.waveform_420_file_name = loaded_combined_dict['waveform_420_file_name']
        self.waveform_1013_file_name = loaded_combined_dict['waveform_1013_file_name']
